...
class AlgoEvent:
    def __init__(self):
        ...
        self.sma_period = 20
        self.std_period = 20
        self.z_long_entry = -1.2
        self.z_short_entry = 1.2
        self.atr_period = 14
    ...
    def on_marketdatafeed(self, md, ab):
        ...
        count = max(self.sma_period, self.std_period) + self.atr_period + 60
        ...
        side = 0
        if zscore <= self.z_long_entry:
            side = 1
        elif zscore >= self.z_short_entry:
            side = -1
        else:
            return
    ...
    def _calc_volume(self, entry_price, stop_loss):
        ...
        stop_distance = max(abs(entry_price - stop_loss), 0.01)
